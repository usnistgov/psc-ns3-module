...
main(int argc, char* argv[])
{
    ...
    cmd.AddValue("on-off-mean",
                 "The average number of seconds a user pushes and releases the button.",
                 onOffMean);
    ...
    mcpttClientHelper.SetPttApp("ns3::psc::McpttPttApp", "PushOnStart", BooleanValue(true));
    ...
    // p2ph.EnablePcap("example-mcptt-on-network-floor-control-lte.ims.pcap",
    // imsHelper->GetImsGmDevice (), true, true);
