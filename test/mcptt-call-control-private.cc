...
class PrivateTestCallMachine : public McpttCallMachinePrivate
{
  public:
    ...
    PrivateTestCallMachine();
    ~PrivateTestCallMachine() override;
    void ChangeState(Ptr<McpttCallMachinePrivateState> newState) override;
  ...
  protected:
    ...
    void ExpiryOfTfp2() override;
    void ExpiryOfTfp3() override;
    void ExpiryOfTfp5() override;
  ...
  private:
    ...
    Callback<void,
             const PrivateTestCallMachine&,
             Ptr<McpttCallMachinePrivateState>,
             Ptr<McpttCallMachinePrivateState>>
        m_stateChangeCb;

  public:
    virtual Callback<void, const PrivateTestCallMachine&, const McpttCallMsg&> GetPostRxCb() const;
    virtual Callback<void, const PrivateTestCallMachine&, const McpttTimer&> GetPostTimerExpCb()
        const;
    virtual Callback<void, const PrivateTestCallMachine&, const McpttCallMsg&> GetPostTxCb() const;
    virtual Callback<void, const PrivateTestCallMachine&, const McpttCallMsg&> GetPreRxCb() const;
    virtual Callback<void, const PrivateTestCallMachine&, const McpttTimer&> GetPreTimerExpCb()
        const;
    virtual Callback<void, const PrivateTestCallMachine&, const McpttCallMsg&> GetPreTxCb() const;
    virtual Ptr<McpttCallMachinePrivateState> GetStartState() const;
    ...
    virtual void SetPostRxCb(
        const Callback<void, const PrivateTestCallMachine&, const McpttCallMsg&> postRxCb);
    virtual void SetPostTimerExpCb(
        const Callback<void, const PrivateTestCallMachine&, const McpttTimer&> timerExpCb);
    virtual void SetPostTxCb(
        const Callback<void, const PrivateTestCallMachine&, const McpttCallMsg&> postTxCb);
    virtual void SetPreRxCb(
        const Callback<void, const PrivateTestCallMachine&, const McpttCallMsg&> preRxCb);
    virtual void SetPreTimerExpCb(
        const Callback<void, const PrivateTestCallMachine&, const McpttTimer&> timerExpCb);
    virtual void SetPreTxCb(
        const Callback<void, const PrivateTestCallMachine&, const McpttCallMsg&> preTxCb);
    virtual void SetStartState(Ptr<McpttCallMachinePrivateState> startState);
    virtual void SetStateChangeTestCb(
        const Callback<void,
                       const PrivateTestCallMachine&,
                       Ptr<McpttCallMachinePrivateState>,
                       Ptr<McpttCallMachinePrivateState>> stateChangeCb);
};

class PrivateCallSetupAuto1 : public McpttTestCase
{
  public:
    PrivateCallSetupAuto1(
        const std::string& name = "Private Call Setup - Establish New Call in Automatic Mode 1",
  ...
  protected:
    ...
    virtual void UeAStateChangeCb(const PrivateTestCallMachine& machine,
                                  Ptr<McpttCallMachinePrivateState> oldState,
                                  Ptr<McpttCallMachinePrivateState> newState);
    ...
    virtual void UeBStateChangeCb(const PrivateTestCallMachine& machine,
                                  Ptr<McpttCallMachinePrivateState> oldState,
                                  Ptr<McpttCallMachinePrivateState> newState);
...
{
  public:
    PrivateCallSetupAuto3(
        const std::string& name = "Private Call Setup - Establish New Call in Automatic Mode 3",
        Ptr<McpttTestCaseConfig> config = Create<McpttTestCaseConfig>());
...
{
  public:
    PrivateCallSetupManual1(
        const std::string& name = "Private Call Setup - Establish New Call in Manual Mode 1",
        Ptr<McpttTestCaseConfig> config = Create<McpttTestCaseConfig>());
...
{
  public:
    PrivateCallSetupManual3(
        const std::string& name = "Private Call Setup - Establish New Call in Manual Mode 3",
        Ptr<McpttTestCaseConfig> config = Create<McpttTestCaseConfig>());
...
{
  public:
    PrivateCallSetupFailure(const std::string& name = "Private Call Setup - Failure to New Call",
                            Ptr<McpttTestCaseConfig> config = Create<McpttTestCaseConfig>());
...
class PrivateCallCancel1 : public McpttTestCase
{
  public:
    PrivateCallCancel1(
        const std::string& name = "Private Call Cancelation - Cancel an Ongoing Call 1",
        Ptr<McpttTestCaseConfig> config = Create<McpttTestCaseConfig>());
...
class PrivateCallCancel2 : public McpttTestCase
{
  public:
    PrivateCallCancel2(
        const std::string& name = "Private Call Cancelation - Cancel an Ongoing Call 2",
        Ptr<McpttTestCaseConfig> config = Create<McpttTestCaseConfig>());
...
{
  public:
    PrivateCallExpiration(const std::string& name = "Private Call Expiration",
                          Ptr<McpttTestCaseConfig> config = Create<McpttTestCaseConfig>());
...
{
  public:
    McpttPrivateCallControlTestSuite();
};
...
TypeId
PrivateTestCallMachine::GetTypeId()
{
...
PrivateTestCallMachine::PrivateTestCallMachine()
...
void
PrivateTestCallMachine::ExpiryOfTfp1()
{
    Ptr<McpttTimer> tfg = GetTfp1();
    Callback<void, const PrivateTestCallMachine&, const McpttTimer&> postTimerExpCb =
        GetPostTimerExpCb();
    Callback<void, const PrivateTestCallMachine&, const McpttTimer&> preTimerExpCb =
        GetPreTimerExpCb();
...
void
PrivateTestCallMachine::ExpiryOfTfp2()
{
...
void
PrivateTestCallMachine::ExpiryOfTfp3()
{
...
void
PrivateTestCallMachine::ExpiryOfTfp5()
{
...
TypeId
PrivateTestCallMachine::GetInstanceTypeId() const
{
    return PrivateTestCallMachine::GetTypeId();
}

Callback<void, const PrivateTestCallMachine&, const McpttCallMsg&>
PrivateTestCallMachine::GetPostRxCb() const
{
    return m_postRxCb;
}

Callback<void, const PrivateTestCallMachine&, const McpttTimer&>
PrivateTestCallMachine::GetPostTimerExpCb() const
{
    return m_postTimerExpCb;
}

Callback<void, const PrivateTestCallMachine&, const McpttCallMsg&>
PrivateTestCallMachine::GetPostTxCb() const
{
    return m_postTxCb;
}

Callback<void, const PrivateTestCallMachine&, const McpttCallMsg&>
PrivateTestCallMachine::GetPreRxCb() const
{
    return m_preRxCb;
}

Callback<void, const PrivateTestCallMachine&, const McpttTimer&>
PrivateTestCallMachine::GetPreTimerExpCb() const
{
    return m_preTimerExpCb;
}

Callback<void, const PrivateTestCallMachine&, const McpttCallMsg&>
PrivateTestCallMachine::GetPreTxCb() const
{
    return m_preTxCb;
}

Ptr<McpttCallMachinePrivateState>
PrivateTestCallMachine::GetStartState() const
{
    return m_startState;
}
...
Callback<void,
         ...
         Ptr<McpttCallMachinePrivateState>,
         Ptr<McpttCallMachinePrivateState>>
PrivateTestCallMachine::GetStateChangeCb() const
{
    return m_stateChangeCb;
}

void
PrivateTestCallMachine::SetPostRxCb(
    const Callback<void, const PrivateTestCallMachine&, const McpttCallMsg&> postRxCb)
{
    m_postRxCb = postRxCb;
}
...
void
PrivateTestCallMachine::SetPostTimerExpCb(
    const Callback<void, const PrivateTestCallMachine&, const McpttTimer&> timerExpCb)
{
...
void
PrivateTestCallMachine::SetPostTxCb(
    const Callback<void, const PrivateTestCallMachine&, const McpttCallMsg&> postTxCb)
{
    m_postTxCb = postTxCb;
}
...
void
PrivateTestCallMachine::SetPreRxCb(
    const Callback<void, const PrivateTestCallMachine&, const McpttCallMsg&> preRxCb)
{
    m_preRxCb = preRxCb;
}
...
void
PrivateTestCallMachine::SetPreTimerExpCb(
    const Callback<void, const PrivateTestCallMachine&, const McpttTimer&> timerExpCb)
{
...
void
PrivateTestCallMachine::SetPreTxCb(
    const Callback<void, const PrivateTestCallMachine&, const McpttCallMsg&> preTxCb)
{
    m_preTxCb = preTxCb;
}
...
void
PrivateTestCallMachine::SetStateChangeTestCb(
    const Callback<void,
                   const PrivateTestCallMachine&,
                   Ptr<McpttCallMachinePrivateState>,
                   Ptr<McpttCallMachinePrivateState>> stateChangeCb)
...
PrivateCallSetupAuto1::PrivateCallSetupAuto1(const std::string& name,
...
void
PrivateCallSetupAuto1::Configure()
{
    ...
    Ptr<PrivateTestCallMachine> ueAMachine =
        DynamicCast<PrivateTestCallMachine, McpttCallMachine>(GetCallMachine(0));
    Ptr<PrivateTestCallMachine> ueBMachine =
        DynamicCast<PrivateTestCallMachine, McpttCallMachine>(GetCallMachine(1));
...
PrivateCallSetupAuto1::Execute()
{
    ...
    NS_TEST_ASSERT_MSG_EQ(m_ueAP0ToP2,
                          true,
                          "UE A never made transition from "
                              << McpttCallMachinePrivateStateP0::GetStateId().GetName() << " to "
                              << McpttCallMachinePrivateStateP2::GetStateId().GetName() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueAP2ToP4,
                          true,
                          "UE A never made transition from "
                              << McpttCallMachinePrivateStateP2::GetStateId().GetName() << " to "
                              << McpttCallMachinePrivateStateP4::GetStateId().GetName() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueARxAccept,
                          true,
                          "UE A never receieved "
                              << McpttCallMsgPrivateAccept::GetTypeId().GetName() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueATxAcceptAck,
                          true,
                          "UE A never sent " << McpttCallMsgPrivateAcceptAck::GetTypeId().GetName()
                                             << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueATxSetup,
                          true,
                          "UE A never sent " << McpttCallMsgPrivateSetupReq::GetTypeId().GetName()
                                             << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueBP0ToP5,
                          true,
                          "UE B never made transition from "
                              << McpttCallMachinePrivateStateP0::GetStateId().GetName() << " to "
                              << McpttCallMachinePrivateStateP5::GetStateId().GetName() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueBP5ToP4,
                          true,
                          "UE B never made transition from "
                              << McpttCallMachinePrivateStateP5::GetStateId().GetName() << " to "
                              << McpttCallMachinePrivateStateP4::GetStateId().GetName() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueBRxSetup,
                          true,
                          "UE B never received "
                              << McpttCallMsgPrivateSetupReq::GetTypeId().GetName() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueBRxAcceptAck,
                          true,
                          "UE B never received "
                              << McpttCallMsgPrivateAcceptAck::GetTypeId().GetName() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueBTxAccept,
                          true,
                          "UE B never sent " << McpttCallMsgPrivateAccept::GetTypeId().GetName()
                                             << ".");
}
...
PrivateCallSetupAuto1::UeARxCb(const PrivateTestCallMachine& machine, const McpttCallMsg& msg)
{
    ...
    if (msg.IsA(McpttCallMsgPrivateAccept::GetTypeId()))
    {
        NS_TEST_ASSERT_MSG_EQ(m_ueAP0ToP2,
                              true,
                              "UE A never made transition from "
                                  << McpttCallMachinePrivateStateP0::GetStateId().GetName()
                                  << " to "
                                  << McpttCallMachinePrivateStateP2::GetStateId().GetName() << ".");
        NS_TEST_ASSERT_MSG_EQ(m_ueAP2ToP4,
                              true,
    ...
    NS_TEST_ASSERT_MSG_EQ(state->GetInstanceStateId(),
                          ...
                          "UE A in state " << state->GetInstanceStateId() << " but should be in "
                                           << McpttCallMachinePrivateStateP4::GetStateId() << ".");
...
void
PrivateCallSetupAuto1::UeAStateChangeCb(const PrivateTestCallMachine& machine,
                                        Ptr<McpttCallMachinePrivateState> oldState,
                                        Ptr<McpttCallMachinePrivateState> newState)
{
    Ptr<McpttTimer> tfp1 = machine.GetTfp1();
        ...
        newState->GetInstanceStateId() == McpttCallMachinePrivateStateP2::GetStateId())
    {
        ...
        NS_TEST_ASSERT_MSG_EQ(tfp1->IsRunning(),
                              true,
                              "UE A timer " << *tfp1 << " is not running.");
             ...
             newState->GetInstanceStateId() == McpttCallMachinePrivateStateP4::GetStateId())
    {
        ...
        NS_TEST_ASSERT_MSG_EQ(m_ueATxSetup,
                              ...
                              "UE A never sent "
                                  << McpttCallMsgPrivateSetupReq::GetTypeId().GetName() << ".");
        NS_TEST_ASSERT_MSG_EQ(tfp1->IsRunning(), false, "UE A timer " << *tfp1 << " is running.");
        NS_TEST_ASSERT_MSG_EQ(tfp5->IsRunning(),
                              true,
                              "UE A timer " << *tfp5 << " is not running.");
        m_ueAP2ToP4 = true;
    }
    else
    {
...
PrivateCallSetupAuto1::UeATxCb(const PrivateTestCallMachine& machine, const McpttCallMsg& msg)
{
    ...
    else
    {
        NS_TEST_ASSERT_MSG_EQ(true,
                              false,
                              "UE A received unexpected " << msg.GetInstanceTypeId()
                                                          << " message.");
    }
...
PrivateCallSetupAuto1::UeBRxCb(const PrivateTestCallMachine& machine, const McpttCallMsg& msg)
{
    ...
    if (msg.IsA(McpttCallMsgPrivateSetupReq::GetTypeId()))
    {
        ...
        NS_TEST_ASSERT_MSG_EQ(m_ueBTxAccept,
                              ...
                              "UE B never sent " << McpttCallMsgPrivateAccept::GetTypeId().GetName()
                                                 << ".");
        NS_TEST_ASSERT_MSG_EQ(tfp4->IsRunning(),
                              true,
                              "UE A timer " << *tfp4 << " is not running.");
        NS_TEST_ASSERT_MSG_EQ(tfp5->IsRunning(), false, "UE A timer " << *tfp5 << " is running.");
        NS_TEST_ASSERT_MSG_EQ(state->GetInstanceStateId(),
...
void
PrivateCallSetupAuto1::UeBStateChangeCb(const PrivateTestCallMachine& machine,
                                        Ptr<McpttCallMachinePrivateState> oldState,
                                        Ptr<McpttCallMachinePrivateState> newState)
{
    Ptr<McpttTimer> tfp1 = machine.GetTfp1();
...
PrivateCallSetupAuto3::PrivateCallSetupAuto3(const std::string& name,
                                             Ptr<McpttTestCaseConfig> config)
    : McpttTestCase(name, config),
      m_ueAP0ToP2(false),
      m_ueAP2ToP3(false),
...
void
PrivateCallSetupAuto3::Configure()
{
    GetConfig()->SetAppCount(2);
    GetConfig()->SetCallTid(PrivateTestCallMachine::GetTypeId());
...
PrivateCallSetupAuto3::Execute()
{
    ...
    NS_TEST_ASSERT_MSG_EQ(m_ueAP0ToP2,
                          ...
                          "UE A never made the transition from "
                              << McpttCallMachinePrivateStateP0::GetStateId() << " to "
                              << McpttCallMachinePrivateStateP2::GetStateId() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueAP2ToP3,
                          true,
                          "UE A never made the transition from "
                              << McpttCallMachinePrivateStateP2::GetStateId() << " to "
                              << McpttCallMachinePrivateStateP1::GetStateId() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueARxAccept,
                          true,
                          "UE A never received " << McpttCallMsgPrivateAccept::GetTypeId().GetName()
                                                 << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueATxRelease,
                          true,
                          "UE A never sent " << McpttCallMsgPrivateRelease::GetTypeId().GetName()
                                             << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueATxSetup,
                          true,
                          "UE A never sent " << McpttCallMsgPrivateSetupReq::GetTypeId().GetName()
    ...
    NS_TEST_ASSERT_MSG_EQ(m_ueBP0ToP5,
                          ...
                          "UE B never made the transition from "
                              << McpttCallMachinePrivateStateP0::GetStateId() << " to "
                              << McpttCallMachinePrivateStateP5::GetStateId() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueBP5ToP1,
                          true,
                          "UE B never made the transition from "
                              << McpttCallMachinePrivateStateP5::GetStateId() << " to "
                              << McpttCallMachinePrivateStateP1::GetStateId() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueBRxSetup,
                          true,
                          "UE B never received "
    ...
    NS_TEST_ASSERT_MSG_EQ(m_ueBRxRelease,
                          true,
                          "UE B never received "
                              << McpttCallMsgPrivateRelease::GetTypeId().GetName() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueBTxAccept,
                          true,
                          "UE B never sent " << McpttCallMsgPrivateAccept::GetTypeId().GetName()
                                             << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueBTxReleaseAck,
                          true,
                          "UE B never sent " << McpttCallMsgPrivateReleaseAck::GetTypeId().GetName()
                                             << ".");
}
...
void
PrivateCallSetupAuto3::UeAStateChangeCb(const PrivateTestCallMachine& machine,
                                        Ptr<McpttCallMachinePrivateState> oldState,
                                        Ptr<McpttCallMachinePrivateState> newState)
{
    Ptr<McpttTimer> tfp1 = machine.GetTfp1();
        ...
        newState->GetInstanceStateId() == McpttCallMachinePrivateStateP2::GetStateId())
    {
        NS_TEST_ASSERT_MSG_EQ(m_ueAP0ToP2,
                              false,
                              "UE A already made the transition from "
                                  << McpttCallMachinePrivateStateP0::GetStateId() << " to "
                                  << McpttCallMachinePrivateStateP2::GetStateId() << ".");
        NS_TEST_ASSERT_MSG_EQ(m_ueAP2ToP3,
                              false,
             ...
             newState->GetInstanceStateId() == McpttCallMachinePrivateStateP3::GetStateId())
    {
        ...
        NS_TEST_ASSERT_MSG_EQ(m_ueATxSetup,
                              ...
                              "UE A never sent "
                                  << McpttCallMsgPrivateSetupReq::GetTypeId().GetName() << ".");
        NS_TEST_ASSERT_MSG_EQ(tfp3->IsRunning(),
                              true,
                              "UE A timer " << *tfp3 << " is not running.");
        m_ueAP2ToP3 = true;
    }
    else
    {
...
PrivateCallSetupAuto3::UeBRxCb(const PrivateTestCallMachine& machine, const McpttCallMsg& msg)
{
    ...
    if (msg.IsA(McpttCallMsgPrivateSetupReq::GetTypeId()))
    {
        ...
        NS_TEST_ASSERT_MSG_EQ(m_ueBTxReleaseAck,
                              false,
                              "UE B already sent "
                                  << McpttCallMsgPrivateReleaseAck::GetTypeId().GetName() << ".");
        NS_TEST_ASSERT_MSG_EQ(tfp4->IsRunning(),
                              true,
                              "UE A timer " << *tfp4 << " is not running.");
        NS_TEST_ASSERT_MSG_EQ(tfp7->IsRunning(), false, "UE A timer " << *tfp7 << " is running.");
    ...
    else if (msg.IsA(McpttCallMsgPrivateRelease::GetTypeId()))
    {
        ...
        NS_TEST_ASSERT_MSG_EQ(m_ueBTxReleaseAck,
                              ...
                              "UE B never sent "
                                  << McpttCallMsgPrivateReleaseAck::GetTypeId().GetName() << ".");
        NS_TEST_ASSERT_MSG_EQ(tfp4->IsRunning(), false, "UE A timer " << *tfp4 << " is running.");
        NS_TEST_ASSERT_MSG_EQ(tfp7->IsRunning(),
                              true,
                              "UE A timer " << *tfp7 << " is not running.");
        NS_TEST_ASSERT_MSG_EQ(state->GetInstanceStateId(),
                              McpttCallMachinePrivateStateP1::GetStateId(),
                              "UE A in state "
                                  << state->GetInstanceStateId() << " but should be in "
...
void
PrivateCallSetupAuto3::UeBStateChangeCb(const PrivateTestCallMachine& machine,
                                        Ptr<McpttCallMachinePrivateState> oldState,
                                        Ptr<McpttCallMachinePrivateState> newState)
{
    Ptr<McpttTimer> tfp1 = machine.GetTfp1();
...
PrivateCallSetupManual1::PrivateCallSetupManual1(const std::string& name,
                                                 Ptr<McpttTestCaseConfig> config)
    : McpttTestCase(name, config),
      m_ueAP0ToP2(false),
      m_ueAP2ToP4(false),
...
void
PrivateCallSetupManual1::Configure()
{
    GetConfig()->SetAppCount(2);
    GetConfig()->SetCallTid(PrivateTestCallMachine::GetTypeId());
    ...
    ueAMachine->SetStateChangeTestCb(
        MakeCallback(&PrivateCallSetupManual1::UeAStateChangeCb, this));
    ...
    ueBMachine->SetStateChangeTestCb(
        MakeCallback(&PrivateCallSetupManual1::UeBStateChangeCb, this));
...
void
PrivateCallSetupManual1::Execute()
{
    NS_LOG_LOGIC("Starting " << GetName() << "...");
    ...
    NS_TEST_ASSERT_MSG_EQ(m_ueARxAccept,
                          ...
                          "UE A never receieved "
                              << McpttCallMsgPrivateAccept::GetTypeId().GetName() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueARxRinging,
                          true,
                          "UE A never receieved "
                              << McpttCallMsgPrivateRinging::GetTypeId().GetName() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueATxAcceptAck,
                          true,
                          "UE A never sent " << McpttCallMsgPrivateAcceptAck::GetTypeId().GetName()
                                             << ".");
    ...
    NS_TEST_ASSERT_MSG_EQ(m_ueBTxAccept,
                          ...
                          "UE B never sent " << McpttCallMsgPrivateAccept::GetTypeId().GetName()
                                             << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueBTxRinging,
                          true,
                          "UE B never sent " << McpttCallMsgPrivateRinging::GetTypeId().GetName()
                                             << ".");
}

void
PrivateCallSetupManual1::UeATimerExpCb(const PrivateTestCallMachine& machine,
...
void
PrivateCallSetupManual1::UeAStateChangeCb(const PrivateTestCallMachine& machine,
                                          Ptr<McpttCallMachinePrivateState> oldState,
                                          Ptr<McpttCallMachinePrivateState> newState)
{
    Ptr<McpttTimer> tfp1 = machine.GetTfp1();
...
void
PrivateCallSetupManual1::UeBTimerExpCb(const PrivateTestCallMachine& machine,
                                       const McpttTimer& timer)
{
    NS_TEST_ASSERT_MSG_EQ(false, true, "UE B timer " << timer << " unexpectedly expired.");
}
...
PrivateCallSetupManual1::UeBRxCb(const PrivateTestCallMachine& machine, const McpttCallMsg& msg)
{
    ...
    if (msg.IsA(McpttCallMsgPrivateSetupReq::GetTypeId()))
    {
        ...
        NS_TEST_ASSERT_MSG_EQ(m_ueBTxRinging,
                              ...
                              "UE B never sent "
                                  << McpttCallMsgPrivateRinging::GetTypeId().GetName() << ".");
        NS_TEST_ASSERT_MSG_EQ(tfp2->IsRunning(),
                              true,
                              "UE A timer " << *tfp2 << " is not running.");
        NS_TEST_ASSERT_MSG_EQ(tfp5->IsRunning(), false, "UE A timer " << *tfp5 << " is running.");
        NS_TEST_ASSERT_MSG_EQ(state->GetInstanceStateId(),
                              McpttCallMachinePrivateStateP5::GetStateId(),
                              "UE A in state "
...
void
PrivateCallSetupManual1::UeBStateChangeCb(const PrivateTestCallMachine& machine,
                                          Ptr<McpttCallMachinePrivateState> oldState,
                                          Ptr<McpttCallMachinePrivateState> newState)
{
    Ptr<McpttTimer> tfp1 = machine.GetTfp1();
...
PrivateCallSetupManual3::PrivateCallSetupManual3(const std::string& name,
                                                 Ptr<McpttTestCaseConfig> config)
    : McpttTestCase(name, config),
      m_ueAP0ToP2(false),
      m_ueAP2ToP3(false),
...
void
PrivateCallSetupManual3::Configure()
{
    GetConfig()->SetAppCount(2);
    GetConfig()->SetCallTid(PrivateTestCallMachine::GetTypeId());
    ...
    ueAMachine->SetStateChangeTestCb(
        MakeCallback(&PrivateCallSetupManual3::UeAStateChangeCb, this));
    ...
    ueBMachine->SetStateChangeTestCb(
        MakeCallback(&PrivateCallSetupManual3::UeBStateChangeCb, this));
...
void
PrivateCallSetupManual3::Execute()
{
    NS_LOG_LOGIC("Starting " << GetName() << "...");
    ...
    NS_TEST_ASSERT_MSG_EQ(m_ueAP2ToP3,
                          ...
                          "UE A never made transition from "
                              << McpttCallMachinePrivateStateP2::GetStateId().GetName() << " to "
                              << McpttCallMachinePrivateStateP3::GetStateId().GetName() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueARxAccept,
                          true,
                          "UE A never receieved "
                              << McpttCallMsgPrivateAccept::GetTypeId().GetName() << ".");
    ...
    NS_TEST_ASSERT_MSG_EQ(m_ueBP5ToP1,
                          ...
                          "UE B never made transition from "
                              << McpttCallMachinePrivateStateP5::GetStateId().GetName() << " to "
                              << McpttCallMachinePrivateStateP1::GetStateId().GetName() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueBRxSetup,
                          true,
                          "UE B never received "
                              << McpttCallMsgPrivateSetupReq::GetTypeId().GetName() << ".");
...
void
PrivateCallSetupManual3::UeATimerExpCb(const PrivateTestCallMachine& machine,
                                       const McpttTimer& timer)
{
    NS_TEST_ASSERT_MSG_EQ(false, true, "UE A timer " << timer << " expired.");
}
...
void
PrivateCallSetupManual3::UeAStateChangeCb(const PrivateTestCallMachine& machine,
                                          Ptr<McpttCallMachinePrivateState> oldState,
                                          Ptr<McpttCallMachinePrivateState> newState)
{
    Ptr<McpttTimer> tfp1 = machine.GetTfp1();
...
void
PrivateCallSetupManual3::UeBTimerExpCb(const PrivateTestCallMachine& machine,
                                       const McpttTimer& timer)
{
    NS_TEST_ASSERT_MSG_EQ(false, true, "UE B timer " << timer << " unexpectedly expired.");
}
...
void
PrivateCallSetupManual3::UeBStateChangeCb(const PrivateTestCallMachine& machine,
                                          Ptr<McpttCallMachinePrivateState> oldState,
                                          Ptr<McpttCallMachinePrivateState> newState)
{
    Ptr<McpttTimer> tfp1 = machine.GetTfp1();
...
PrivateCallSetupFailure::PrivateCallSetupFailure(const std::string& name,
                                                 Ptr<McpttTestCaseConfig> config)
    : McpttTestCase(name, config),
      m_ueAP0ToP2(false),
      m_ueAP2ToP1(false),
...
void
PrivateCallSetupFailure::Configure()
{
    GetConfig()->SetAppCount(2);
    GetConfig()->SetCallTid(PrivateTestCallMachine::GetTypeId());
    ...
    ueAMachine->SetStateChangeTestCb(
        MakeCallback(&PrivateCallSetupFailure::UeAStateChangeCb, this));
    ...
    ueBMachine->SetStateChangeTestCb(
        MakeCallback(&PrivateCallSetupFailure::UeBStateChangeCb, this));
...
void
PrivateCallSetupFailure::Execute()
{
    NS_LOG_LOGIC("Starting " << GetName() << "...");
    ...
    NS_TEST_ASSERT_MSG_EQ(m_ueAP0ToP2,
                          ...
                          "UE A never made transition from "
                              << McpttCallMachinePrivateStateP0::GetStateId() << " to "
                              << McpttCallMachinePrivateStateP2::GetStateId() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueAP2ToP1,
                          true,
                          "UE A never made transition from "
                              << McpttCallMachinePrivateStateP2::GetStateId() << " to "
                              << McpttCallMachinePrivateStateP1::GetStateId() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueARxReject,
                          true,
                          "UE A never received " << McpttCallMsgPrivateReject::GetTypeId().GetName()
                                                 << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueATxSetup,
                          true,
                          "UE A never sent " << McpttCallMsgPrivateSetupReq::GetTypeId().GetName()
                                             << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueBP0ToP1,
                          true,
                          "UE B never made transition from "
                              << McpttCallMachinePrivateStateP1::GetStateId() << " to "
                              << McpttCallMachinePrivateStateP1::GetStateId() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueBRxSetup,
                          true,
                          "UE B never received "
    ...
    NS_TEST_ASSERT_MSG_EQ(m_ueBTxReject,
                          true,
                          "UE B never sent " << McpttCallMsgPrivateReject::GetTypeId().GetName()
                                             << ".");
}

void
PrivateCallSetupFailure::UeATimerExpCb(const PrivateTestCallMachine& machine,
                                       const McpttTimer& timer)
{
    NS_TEST_ASSERT_MSG_EQ(false, true, "UE A timer " << timer << " expired.");
}
...
PrivateCallSetupFailure::UeARxCb(const PrivateTestCallMachine& machine, const McpttCallMsg& msg)
{
    ...
    if (msg.IsA(McpttCallMsgPrivateReject::GetTypeId()))
    {
        ...
        NS_TEST_ASSERT_MSG_EQ(m_ueARxReject,
                              false,
                              "UE A already received "
                                  << McpttCallMsgPrivateReject::GetTypeId().GetName() << ".");
        NS_TEST_ASSERT_MSG_EQ(m_ueATxSetup,
                              true,
                              "UE A never sent "
                                  << McpttCallMsgPrivateSetupReq::GetTypeId().GetName() << ".");
...
void
PrivateCallSetupFailure::UeAStateChangeCb(const PrivateTestCallMachine& machine,
                                          Ptr<McpttCallMachinePrivateState> oldState,
                                          Ptr<McpttCallMachinePrivateState> newState)
{
    Ptr<McpttTimer> tfp1 = machine.GetTfp1();
...
void
PrivateCallSetupFailure::UeBTimerExpCb(const PrivateTestCallMachine& machine,
                                       const McpttTimer& timer)
{
    NS_TEST_ASSERT_MSG_EQ(false, true, "UE B timer " << timer << " unexpectedly expired.");
}
...
void
PrivateCallSetupFailure::UeBStateChangeCb(const PrivateTestCallMachine& machine,
                                          Ptr<McpttCallMachinePrivateState> oldState,
                                          Ptr<McpttCallMachinePrivateState> newState)
{
    Ptr<McpttTimer> tfp1 = machine.GetTfp1();
...
PrivateCallCancel1::Execute()
{
    ...
    NS_TEST_ASSERT_MSG_EQ(m_ueAP3ToP1,
                          true,
                          "UE A never made the transition from "
                              << McpttCallMachinePrivateStateP3::GetStateId() << " to "
                              << McpttCallMachinePrivateStateP1::GetStateId() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueAP4ToP3,
                          true,
                          "UE A never made the transition from "
                              << McpttCallMachinePrivateStateP4::GetStateId() << " to "
                              << McpttCallMachinePrivateStateP3::GetStateId() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueARxReleaseAck,
                          true,
                          "UE A never received "
                              << McpttCallMsgPrivateReleaseAck::GetTypeId().GetName() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueATxRelease,
                          ...
                          "UE A never sent " << McpttCallMsgPrivateRelease::GetTypeId().GetName()
                                             << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueBP4ToP1,
                          true,
                          "UE B never made the transition from "
                              << McpttCallMachinePrivateStateP4::GetStateId() << " to "
                              << McpttCallMachinePrivateStateP1::GetStateId() << ".");
...
void
PrivateCallCancel1::UeAStateChangeCb(const PrivateTestCallMachine& machine,
                                     Ptr<McpttCallMachinePrivateState> oldState,
                                     Ptr<McpttCallMachinePrivateState> newState)
{
    Ptr<McpttTimer> tfp1 = machine.GetTfp1();
...
void
PrivateCallCancel1::UeBStateChangeCb(const PrivateTestCallMachine& machine,
                                     Ptr<McpttCallMachinePrivateState> oldState,
                                     Ptr<McpttCallMachinePrivateState> newState)
{
    Ptr<McpttTimer> tfp1 = machine.GetTfp1();
...
void
PrivateCallCancel2::UeAStateChangeCb(const PrivateTestCallMachine& machine,
                                     Ptr<McpttCallMachinePrivateState> oldState,
                                     Ptr<McpttCallMachinePrivateState> newState)
{
    Ptr<McpttTimer> tfp1 = machine.GetTfp1();
...
void
PrivateCallCancel2::UeBStateChangeCb(const PrivateTestCallMachine& machine,
                                     Ptr<McpttCallMachinePrivateState> oldState,
                                     Ptr<McpttCallMachinePrivateState> newState)
{
    NS_TEST_ASSERT_MSG_EQ(true,
...
PrivateCallExpiration::PrivateCallExpiration(const std::string& name,
                                             Ptr<McpttTestCaseConfig> config)
    : McpttTestCase(name, config),
      m_ueAExpTfp5(false),
      m_ueAP1ToP2(false),
...
void
PrivateCallExpiration::Configure()
{
    GetConfig()->SetAppCount(2);
    GetConfig()->SetCallTid(PrivateTestCallMachine::GetTypeId());
...
PrivateCallExpiration::Execute()
{
    ...
    NS_TEST_ASSERT_MSG_EQ(m_ueAP1ToP2,
                          true,
                          "UE A never made transition from "
                              << McpttCallMachinePrivateStateP1::GetStateId().GetName() << " to "
                              << McpttCallMachinePrivateStateP2::GetStateId().GetName() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueAP4ToP1,
                          true,
                          "UE A never made transition from "
                              << McpttCallMachinePrivateStateP4::GetStateId().GetName() << " to "
                              << McpttCallMachinePrivateStateP1::GetStateId().GetName() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueARxRinging,
                          true,
                          "UE A never receieved "
    ...
    NS_TEST_ASSERT_MSG_EQ(m_ueBP1ToP5,
                          true,
                          "UE B never made transition from "
                              << McpttCallMachinePrivateStateP1::GetStateId().GetName() << " to "
                              << McpttCallMachinePrivateStateP5::GetStateId().GetName() << ".");
...
void
PrivateCallExpiration::UeAStateChangeCb(const PrivateTestCallMachine& machine,
                                        Ptr<McpttCallMachinePrivateState> oldState,
                                        Ptr<McpttCallMachinePrivateState> newState)
{
    Ptr<McpttTimer> tfp1 = machine.GetTfp1();
...
PrivateCallExpiration::UeBTimerExpCb(const PrivateTestCallMachine& machine, const McpttTimer& timer)
{
    ...
    NS_TEST_ASSERT_MSG_EQ(state->GetInstanceStateId(),
                          McpttCallMachinePrivateStateP1::GetStateId(),
                          "UE B in state " << state->GetInstanceStateId() << " but should be in "
                                           << McpttCallMachinePrivateStateP1::GetStateId() << ".");
...
void
PrivateCallExpiration::UeBStateChangeCb(const PrivateTestCallMachine& machine,
                                        Ptr<McpttCallMachinePrivateState> oldState,
                                        Ptr<McpttCallMachinePrivateState> newState)
{
    Ptr<McpttTimer> tfp1 = machine.GetTfp1();
        ...
        newState->GetInstanceStateId() == McpttCallMachinePrivateStateP1::GetStateId())
    {
        ...
        NS_TEST_ASSERT_MSG_EQ(tfp7->IsRunning(),
                              true,
                              "UE B timer " << *tfp7 << " is not running.");
        m_ueBP4ToP1 = true;
    }
    else if (oldState->GetInstanceStateId() == McpttCallMachinePrivateStateP1::GetStateId() &&
             newState->GetInstanceStateId() == McpttCallMachinePrivateStateP5::GetStateId())
    {
        ...
        NS_TEST_ASSERT_MSG_EQ(tfp2->IsRunning(),
                              true,
                              "UE B timer " << *tfp2 << " is not running.");
        NS_TEST_ASSERT_MSG_EQ(tfp7->IsRunning(), false, "UE B timer " << *tfp7 << " is running.");
        m_ueBP1ToP5 = true;
    }
    else
