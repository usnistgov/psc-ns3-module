...
class BroadcastTestCallMachine : public McpttCallMachineGrpBroadcast
{
  ...
  public:
    virtual Callback<void, const BroadcastTestCallMachine&, const McpttCallMsg&> GetPostRxCb()
        const;
    virtual Callback<void, const BroadcastTestCallMachine&, const McpttTimer&> GetPostTimerExpCb()
        const;
    virtual Callback<void, const BroadcastTestCallMachine&, const McpttCallMsg&> GetPostTxCb()
        const;
    ...
    virtual void SetPostRxCb(
        const Callback<void, const BroadcastTestCallMachine&, const McpttCallMsg&> postRxCb);
    virtual void SetPostTimerExpCb(
        const Callback<void, const BroadcastTestCallMachine&, const McpttTimer&> timerExpCb);
    virtual void SetPostTxCb(
        const Callback<void, const BroadcastTestCallMachine&, const McpttCallMsg&> postTxCb);
    virtual void SetPreRxCb(
        const Callback<void, const BroadcastTestCallMachine&, const McpttCallMsg&> preRxCb);
    virtual void SetPreTimerExpCb(
        const Callback<void, const BroadcastTestCallMachine&, const McpttTimer&> timerExpCb);
    virtual void SetPreTxCb(
        const Callback<void, const BroadcastTestCallMachine&, const McpttCallMsg&> preTxCb);
    virtual void SetStartState(Ptr<McpttCallMachineGrpBroadcastState> startState);
    virtual void SetStateChangeTestCb(
        const Callback<void,
                       const BroadcastTestCallMachine&,
                       Ptr<McpttCallMachineGrpBroadcastState>,
                       Ptr<McpttCallMachineGrpBroadcastState>> stateChangeCb);
};
...
{
  public:
    BroadcastCallScenario1(const std::string& name = "BroadcastCallScenario1",
  ...
  protected:
    ...
    virtual void UeAStateChangeCb(const BroadcastTestCallMachine& machine,
                                  Ptr<McpttCallMachineGrpBroadcastState> oldState,
                                  Ptr<McpttCallMachineGrpBroadcastState> newState);
    ...
    virtual void UeBStateChangeCb(const BroadcastTestCallMachine& machine,
                                  Ptr<McpttCallMachineGrpBroadcastState> oldState,
                                  Ptr<McpttCallMachineGrpBroadcastState> newState);
    ...
    virtual void UeCStateChangeCb(const BroadcastTestCallMachine& machine,
                                  Ptr<McpttCallMachineGrpBroadcastState> oldState,
                                  Ptr<McpttCallMachineGrpBroadcastState> newState);
...
{
  public:
    BroadcastCallScenario2(const std::string& name = "BroadcastCallScenario2",
                           Ptr<McpttTestCaseConfig> config = Create<McpttTestCaseConfig>());
...
{
  public:
    BroadcastCallScenario3(const std::string& name = "BroadcastCallScenario3",
                           Ptr<McpttTestCaseConfig> config = Create<McpttTestCaseConfig>());
...
{
  public:
    BroadcastCallScenario4(const std::string& name = "BroadcastCallScenario4",
                           Ptr<McpttTestCaseConfig> config = Create<McpttTestCaseConfig>());
...
BroadcastTestCallMachine::ExpiryOfTfb1()
{
    ...
    Callback<void, const BroadcastTestCallMachine&, const McpttTimer&> postTimerExpCb =
        GetPostTimerExpCb();
    Callback<void, const BroadcastTestCallMachine&, const McpttTimer&> preTimerExpCb =
        GetPreTimerExpCb();
...
void
BroadcastTestCallMachine::SetPostRxCb(
    const Callback<void, const BroadcastTestCallMachine&, const McpttCallMsg&> postRxCb)
{
    m_postRxCb = postRxCb;
}
...
void
BroadcastTestCallMachine::SetPostTimerExpCb(
    const Callback<void, const BroadcastTestCallMachine&, const McpttTimer&> timerExpCb)
{
...
void
BroadcastTestCallMachine::SetPostTxCb(
    const Callback<void, const BroadcastTestCallMachine&, const McpttCallMsg&> postTxCb)
{
    m_postTxCb = postTxCb;
}
...
void
BroadcastTestCallMachine::SetPreRxCb(
    const Callback<void, const BroadcastTestCallMachine&, const McpttCallMsg&> preRxCb)
{
    m_preRxCb = preRxCb;
}
...
void
BroadcastTestCallMachine::SetPreTimerExpCb(
    const Callback<void, const BroadcastTestCallMachine&, const McpttTimer&> timerExpCb)
{
...
void
BroadcastTestCallMachine::SetPreTxCb(
    const Callback<void, const BroadcastTestCallMachine&, const McpttCallMsg&> preTxCb)
{
    m_preTxCb = preTxCb;
}
...
void
BroadcastTestCallMachine::SetStateChangeTestCb(
    const Callback<void,
                   const BroadcastTestCallMachine&,
                   Ptr<McpttCallMachineGrpBroadcastState>,
                   Ptr<McpttCallMachineGrpBroadcastState>> stateChangeCb)
...
BroadcastCallScenario1::BroadcastCallScenario1(const std::string& name,
...
BroadcastCallScenario1::Configure()
{
    ...
    Ptr<BroadcastTestCallMachine> ueAMachine =
        DynamicCast<BroadcastTestCallMachine, McpttCallMachine>(GetCallMachine(0));
    Ptr<BroadcastTestCallMachine> ueBMachine =
        DynamicCast<BroadcastTestCallMachine, McpttCallMachine>(GetCallMachine(1));
    Ptr<BroadcastTestCallMachine> ueCMachine =
        DynamicCast<BroadcastTestCallMachine, McpttCallMachine>(GetCallMachine(2));
...
BroadcastCallScenario1::Execute()
{
    ...
    NS_TEST_ASSERT_MSG_EQ(m_ueAB1ToB2,
                          true,
                          "UE A never made transition from "
                              << McpttCallMachineGrpBroadcastStateB1::GetStateId() << " to "
                              << McpttCallMachineGrpBroadcastStateB2::GetStateId() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueATxGrpBroadcast,
                          true,
                          "UE A never sent " << McpttCallMsgGrpBroadcast::GetTypeId().GetName()
                                             << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueBB1ToB3,
                          true,
                          "UE B never made transition from "
                              << McpttCallMachineGrpBroadcastStateB1::GetStateId() << " to "
                              << McpttCallMachineGrpBroadcastStateB3::GetStateId() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueBB3ToB2,
                          true,
                          "UE B never made transition from "
                              << McpttCallMachineGrpBroadcastStateB3::GetStateId() << " to "
                              << McpttCallMachineGrpBroadcastStateB2::GetStateId() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueBRxGrpBroadcast,
                          true,
                          "UE B never received " << McpttCallMsgGrpBroadcast::GetTypeId().GetName()
                                                 << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueCB1ToB2,
                          true,
                          "UE C never made transition from "
                              << McpttCallMachineGrpBroadcastStateB1::GetStateId() << " to "
                              << McpttCallMachineGrpBroadcastStateB3::GetStateId() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueCRxGrpBroadcast,
                          true,
                          "UE C never received " << McpttCallMsgGrpBroadcast::GetTypeId().GetName()
                                                 << ".");
}

void
BroadcastCallScenario1::UeATimerExpCb(const BroadcastTestCallMachine& machine,
...
void
BroadcastCallScenario1::UeAStateChangeCb(const BroadcastTestCallMachine& machine,
                                         Ptr<McpttCallMachineGrpBroadcastState> oldState,
                                         Ptr<McpttCallMachineGrpBroadcastState> newState)
{
    ...
    if (oldState->GetInstanceStateId() == McpttCallMachineGrpBroadcastStateB1::GetStateId() &&
        newState->GetInstanceStateId() == McpttCallMachineGrpBroadcastStateB2::GetStateId())
    {
        NS_TEST_ASSERT_MSG_EQ(m_ueATxGrpBroadcast,
                              true,
                              "UE A never sent " << McpttCallMsgGrpBroadcast::GetTypeId().GetName()
...
BroadcastCallScenario1::UeATxCb(const BroadcastTestCallMachine& machine, const McpttCallMsg& msg)
{
    ...
    if (msg.IsA(McpttCallMsgGrpBroadcast::GetTypeId()))
    {
        ...
        NS_TEST_ASSERT_MSG_EQ(m_ueATxGrpBroadcast,
                              false,
                              "UE A already sent " << McpttCallMsgGrpBroadcast::GetTypeId() << ".");
        NS_TEST_ASSERT_MSG_EQ(m_ueAB1ToB2,
                              false,
                              "UE A already made transition from "
                                  << McpttCallMachineGrpBroadcastStateB1::GetStateId() << " to "
...
void
BroadcastCallScenario1::UeBTimerExpCb(const BroadcastTestCallMachine& machine,
                                      const McpttTimer& timer)
{
    ...
    if (msg.IsA(McpttCallMsgGrpBroadcast::GetTypeId()))
    {
        ...
        NS_TEST_ASSERT_MSG_EQ(m_ueBRxGrpBroadcast,
                              ...
                              "UE B already received "
                                  << McpttCallMsgGrpBroadcast::GetTypeId().GetName() << ".");
        NS_TEST_ASSERT_MSG_EQ(m_ueBB1ToB3,
                              true,
                              "UE B never made transition from "
                                  << McpttCallMachineGrpBroadcastStateB1::GetStateId() << " to "
...
void
BroadcastCallScenario1::UeBStateChangeCb(const BroadcastTestCallMachine& machine,
                                         Ptr<McpttCallMachineGrpBroadcastState> oldState,
                                         Ptr<McpttCallMachineGrpBroadcastState> newState)
{
    Ptr<McpttTimer> tfb1 = machine.GetTfb1();
    ...
    if (oldState->GetInstanceStateId() == McpttCallMachineGrpBroadcastStateB1::GetStateId() &&
        newState->GetInstanceStateId() == McpttCallMachineGrpBroadcastStateB3::GetStateId())
    {
        NS_TEST_ASSERT_MSG_EQ(m_ueBRxGrpBroadcast,
                              false,
                              "UE B already received " << McpttCallMsgGrpBroadcast::GetTypeId()
                                                       << ".");
        NS_TEST_ASSERT_MSG_EQ(m_ueBB1ToB3,
                              false,
    ...
    else if (oldState->GetInstanceStateId() == McpttCallMachineGrpBroadcastStateB3::GetStateId() &&
             newState->GetInstanceStateId() == McpttCallMachineGrpBroadcastStateB2::GetStateId())
    {
        NS_TEST_ASSERT_MSG_EQ(m_ueBRxGrpBroadcast,
                              false,
...
void
BroadcastCallScenario1::UeCTimerExpCb(const BroadcastTestCallMachine& machine,
                                      const McpttTimer& timer)
{
...
BroadcastCallScenario1::UeCRxCb(const BroadcastTestCallMachine& machine, const McpttCallMsg& msg)
{
    ...
    if (msg.IsA(McpttCallMsgGrpBroadcast::GetTypeId()))
    {
        ...
        NS_TEST_ASSERT_MSG_EQ(m_ueCRxGrpBroadcast,
                              false,
                              "UE C already recieved " << McpttCallMsgGrpBroadcast::GetTypeId()
                                                       << ".");
        NS_TEST_ASSERT_MSG_EQ(m_ueCB1ToB2,
                              true,
                              "UE C never made transiton from "
                                  << McpttCallMachineGrpBroadcastStateB1::GetStateId() << " to "
                                  << McpttCallMachineGrpBroadcastStateB2::GetStateId() << ".");
...
void
BroadcastCallScenario1::UeCStateChangeCb(const BroadcastTestCallMachine& machine,
                                         Ptr<McpttCallMachineGrpBroadcastState> oldState,
                                         Ptr<McpttCallMachineGrpBroadcastState> newState)
{
    Ptr<McpttTimer> tfb1 = machine.GetTfb1();
        ...
        newState->GetInstanceStateId() == McpttCallMachineGrpBroadcastStateB2::GetStateId())
    {
        NS_TEST_ASSERT_MSG_EQ(m_ueCRxGrpBroadcast,
                              false,
                              "UE C already received " << McpttCallMsgGrpBroadcast::GetTypeId()
                                                       << ".");
        NS_TEST_ASSERT_MSG_EQ(m_ueCB1ToB2,
                              false,
...
BroadcastCallScenario2::BroadcastCallScenario2(const std::string& name,
                                               Ptr<McpttTestCaseConfig> config)
    : McpttTestCase(name, config),
      m_ueAB1ToB2(false),
      m_ueATxGrpBroadcast(false),
...
BroadcastCallScenario2::Execute()
{
    ...
    NS_TEST_ASSERT_MSG_EQ(m_ueBB1ToB3,
                          ...
                          "UE B never made transition from "
                              << McpttCallMachineGrpBroadcastStateB1::GetStateId() << " to "
                              << McpttCallMachineGrpBroadcastStateB3::GetStateId() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueBB3ToB4,
                          true,
                          "UE B never made transition from "
                              << McpttCallMachineGrpBroadcastStateB3::GetStateId() << " to "
                              << McpttCallMachineGrpBroadcastStateB2::GetStateId() << ".");
...
void
BroadcastCallScenario2::UeATimerExpCb(const BroadcastTestCallMachine& machine,
                                      const McpttTimer& timer)
{
    NS_TEST_ASSERT_MSG_EQ(false, true, "UE A timer " << timer << " expired.");
}
...
void
BroadcastCallScenario2::UeAStateChangeCb(const BroadcastTestCallMachine& machine,
                                         Ptr<McpttCallMachineGrpBroadcastState> oldState,
                                         Ptr<McpttCallMachineGrpBroadcastState> newState)
{
    Ptr<McpttTimer> tfb1 = machine.GetTfb1();
...
BroadcastCallScenario2::UeBNewCallCb(uint16_t callId)
{
    ...
    Ptr<McpttCallMachineGrpBroadcast> callMachine =
        DynamicCast<BroadcastTestCallMachine, McpttCallMachine>(GetCallMachine(1));
    callMachine->RejectCall();
}

void
BroadcastCallScenario2::UeBTimerExpCb(const BroadcastTestCallMachine& machine,
                                      const McpttTimer& timer)
{
    NS_TEST_ASSERT_MSG_EQ(false, true, "UE B timer " << timer << " unexpectedly expired.");
}
...
void
BroadcastCallScenario2::UeBStateChangeCb(const BroadcastTestCallMachine& machine,
                                         Ptr<McpttCallMachineGrpBroadcastState> oldState,
                                         Ptr<McpttCallMachineGrpBroadcastState> newState)
{
    Ptr<McpttTimer> tfb1 = machine.GetTfb1();
        ...
        newState->GetInstanceStateId() == McpttCallMachineGrpBroadcastStateB3::GetStateId())
    {
        ...
        m_ueBB1ToB3 = true;
             ...
             newState->GetInstanceStateId() == McpttCallMachineGrpBroadcastStateB4::GetStateId())
    {
        NS_TEST_ASSERT_MSG_EQ(m_ueBRxGrpBroadcast,
                              false,
                              "UE B already received " << McpttCallMsgGrpBroadcast::GetTypeId()
...
void
BroadcastCallScenario2::UeCTimerExpCb(const BroadcastTestCallMachine& machine,
                                      const McpttTimer& timer)
{
    NS_TEST_ASSERT_MSG_EQ(false, true, "UE C timer " << timer << " unexpectedly expired.");
}
...
void
BroadcastCallScenario2::UeCStateChangeCb(const BroadcastTestCallMachine& machine,
                                         Ptr<McpttCallMachineGrpBroadcastState> oldState,
                                         Ptr<McpttCallMachineGrpBroadcastState> newState)
{
    Ptr<McpttTimer> tfb1 = machine.GetTfb1();
...
BroadcastCallScenario3::BroadcastCallScenario3(const std::string& name,
                                               Ptr<McpttTestCaseConfig> config)
    : McpttTestCase(name, config),
      m_ueAB2ToB1(false),
...
BroadcastCallScenario3::Configure()
{
    ...
    Simulator::Schedule(Seconds(2.15),
...
BroadcastCallScenario3::Execute()
{
    ...
    NS_TEST_ASSERT_MSG_EQ(m_ueAB2ToB1,
                          true,
                          "UE A never made transition from "
                              << McpttCallMachineGrpBroadcastStateB2::GetStateId() << " to "
                              << McpttCallMachineGrpBroadcastStateB1::GetStateId() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueATxGrpBroadcastEnd,
                          true,
                          "UE A never sent " << McpttCallMsgGrpBroadcastEnd::GetTypeId().GetName()
                                             << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueBB2ToB1,
                          true,
                          "UE B never made transition from "
                              << McpttCallMachineGrpBroadcastStateB2::GetStateId() << " to "
                              << McpttCallMachineGrpBroadcastStateB1::GetStateId() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueBRxGrpBroadcastEnd,
                          true,
                          "UE B never received "
                              << McpttCallMsgGrpBroadcastEnd::GetTypeId().GetName() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueCB2ToB1,
                          true,
                          "UE C never made transition from "
                              << McpttCallMachineGrpBroadcastStateB2::GetStateId() << " to "
                              << McpttCallMachineGrpBroadcastStateB1::GetStateId() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueCRxGrpBroadcastEnd,
                          true,
                          "UE C never received "
                              << McpttCallMsgGrpBroadcastEnd::GetTypeId().GetName() << ".");
}
...
void
BroadcastCallScenario3::UeATimerExpCb(const BroadcastTestCallMachine& machine,
                                      const McpttTimer& timer)
{
    NS_TEST_ASSERT_MSG_EQ(false, true, "UE A timer " << timer << " expired.");
}
...
void
BroadcastCallScenario3::UeAStateChangeCb(const BroadcastTestCallMachine& machine,
                                         Ptr<McpttCallMachineGrpBroadcastState> oldState,
                                         Ptr<McpttCallMachineGrpBroadcastState> newState)
{
    Ptr<McpttTimer> tfb1 = machine.GetTfb1();
    ...
    if (oldState->GetInstanceStateId() == McpttCallMachineGrpBroadcastStateB2::GetStateId() &&
        newState->GetInstanceStateId() == McpttCallMachineGrpBroadcastStateB1::GetStateId())
    {
        NS_TEST_ASSERT_MSG_EQ(m_ueATxGrpBroadcastEnd,
                              true,
                              "UE A never sent " << McpttCallMsgGrpBroadcast::GetTypeId().GetName()
...
BroadcastCallScenario3::UeATxCb(const BroadcastTestCallMachine& machine, const McpttCallMsg& msg)
{
    ...
    if (msg.IsA(McpttCallMsgGrpBroadcastEnd::GetTypeId()))
    {
        ...
        NS_TEST_ASSERT_MSG_EQ(m_ueATxGrpBroadcastEnd,
                              false,
                              "UE A already sent " << McpttCallMsgGrpBroadcastEnd::GetTypeId()
                                                   << ".");
        NS_TEST_ASSERT_MSG_EQ(m_ueAB2ToB1,
                              false,
                              "UE A already made transition from "
...
void
BroadcastCallScenario3::UeBTimerExpCb(const BroadcastTestCallMachine& machine,
                                      const McpttTimer& timer)
{
    NS_TEST_ASSERT_MSG_EQ(false, true, "UE B timer " << timer << " unexpectedly expired.");
}
...
void
BroadcastCallScenario3::UeBStateChangeCb(const BroadcastTestCallMachine& machine,
                                         Ptr<McpttCallMachineGrpBroadcastState> oldState,
                                         Ptr<McpttCallMachineGrpBroadcastState> newState)
{
    Ptr<McpttTimer> tfb1 = machine.GetTfb1();
        ...
        newState->GetInstanceStateId() == McpttCallMachineGrpBroadcastStateB1::GetStateId())
    {
        NS_TEST_ASSERT_MSG_EQ(m_ueBRxGrpBroadcastEnd,
                              false,
                              "UE B already received " << McpttCallMsgGrpBroadcastEnd::GetTypeId()
                                                       << ".");
        NS_TEST_ASSERT_MSG_EQ(m_ueBB2ToB1,
                              false,
                              "UE B already made transition from "
...
void
BroadcastCallScenario3::UeCTimerExpCb(const BroadcastTestCallMachine& machine,
                                      const McpttTimer& timer)
{
    NS_TEST_ASSERT_MSG_EQ(false, true, "UE C timer " << timer << " unexpectedly expired.");
}
...
BroadcastCallScenario3::UeCRxCb(const BroadcastTestCallMachine& machine, const McpttCallMsg& msg)
{
    ...
    if (msg.IsA(McpttCallMsgGrpBroadcastEnd::GetTypeId()))
    {
        ...
        NS_TEST_ASSERT_MSG_EQ(m_ueCRxGrpBroadcastEnd,
                              false,
                              "UE C already recieved " << McpttCallMsgGrpBroadcastEnd::GetTypeId()
                                                       << ".");
        NS_TEST_ASSERT_MSG_EQ(m_ueCB2ToB1,
                              true,
                              "UE C never made transiton from "
...
void
BroadcastCallScenario3::UeCStateChangeCb(const BroadcastTestCallMachine& machine,
                                         Ptr<McpttCallMachineGrpBroadcastState> oldState,
                                         Ptr<McpttCallMachineGrpBroadcastState> newState)
{
    Ptr<McpttTimer> tfb1 = machine.GetTfb1();
        ...
        newState->GetInstanceStateId() == McpttCallMachineGrpBroadcastStateB1::GetStateId())
    {
        NS_TEST_ASSERT_MSG_EQ(m_ueCRxGrpBroadcastEnd,
                              false,
                              "UE C already received " << McpttCallMsgGrpBroadcastEnd::GetTypeId()
                                                       << ".");
        NS_TEST_ASSERT_MSG_EQ(m_ueCB2ToB1,
                              false,
                              "UE C already made transition from "
...
BroadcastCallScenario4::BroadcastCallScenario4(const std::string& name,
                                               Ptr<McpttTestCaseConfig> config)
    : McpttTestCase(name, config),
      m_ueAB2ToB1(false),
      m_ueAExpTfb1(false),
...
BroadcastCallScenario4::Execute()
{
    ...
    NS_TEST_ASSERT_MSG_EQ(m_ueATxGrpBroadcast,
                          ...
                          "UE A never sent " << McpttCallMsgGrpBroadcast::GetTypeId().GetName()
                                             << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueBB2ToB4,
                          true,
                          "UE B never made transition from "
                              << McpttCallMachineGrpBroadcastStateB2::GetStateId() << " to "
                              << McpttCallMachineGrpBroadcastStateB4::GetStateId() << ".");
    NS_TEST_ASSERT_MSG_EQ(m_ueBB4ToB1,
                          true,
                          "UE B never made transition from "
                              << McpttCallMachineGrpBroadcastStateB4::GetStateId() << " to "
                              << McpttCallMachineGrpBroadcastStateB1::GetStateId() << ".");
...
void
BroadcastCallScenario4::UeATimerExpCb(const BroadcastTestCallMachine& machine,
                                      const McpttTimer& timer)
{
    Ptr<McpttTimer> tfb1 = machine.GetTfb1();
    Ptr<McpttTimer> tfb2 = machine.GetTfb2();
...
void
BroadcastCallScenario4::UeAStateChangeCb(const BroadcastTestCallMachine& machine,
                                         Ptr<McpttCallMachineGrpBroadcastState> oldState,
                                         Ptr<McpttCallMachineGrpBroadcastState> newState)
{
    Ptr<McpttTimer> tfb1 = machine.GetTfb1();
...
BroadcastCallScenario4::UeATxCb(const BroadcastTestCallMachine& machine, const McpttCallMsg& msg)
{
    ...
    if (msg.IsA(McpttCallMsgGrpBroadcast::GetTypeId()))
    {
        ...
        NS_TEST_ASSERT_MSG_EQ(state,
                              McpttCallMachineGrpBroadcastStateB2::GetInstance(),
                              "UE A in" << state->GetInstanceStateId() << " but should be in "
                                        << McpttCallMachineGrpBroadcastStateB2::GetStateId()
                                        << ".");
        m_ueATxGrpBroadcast = true;
    }
...
void
BroadcastCallScenario4::UeBTimerExpCb(const BroadcastTestCallMachine& machine,
                                      const McpttTimer& timer)
{
    Ptr<McpttTimer> tfb1 = machine.GetTfb1();
    Ptr<McpttTimer> tfb2 = machine.GetTfb2();
    ...
    if (timer.GetId() == machine.GetTfb1()->GetId())
    {
        ...
        NS_TEST_ASSERT_MSG_EQ(m_ueBRxGrpBroadcast,
                              true,
                              "UE B never received " << McpttCallMsgGrpBroadcast::GetTypeId()
                                                     << ".");
        NS_TEST_ASSERT_MSG_EQ(m_ueBB2ToB4,
                              true,
                              "UE B never made transition from "
...
BroadcastCallScenario4::UeBRxCb(const BroadcastTestCallMachine& machine, const McpttCallMsg& msg)
{
    ...
    if (msg.IsA(McpttCallMsgGrpBroadcast::GetTypeId()))
    {
        ...
        NS_TEST_ASSERT_MSG_EQ(state,
                              McpttCallMachineGrpBroadcastStateB4::GetInstance(),
                              "UE B in " << state->GetInstanceStateId() << " not "
                                         << McpttCallMachineGrpBroadcastStateB2::GetStateId()
                                         << " state.");
        m_ueBRxGrpBroadcast = true;
    }
...
void
BroadcastCallScenario4::UeBStateChangeCb(const BroadcastTestCallMachine& machine,
                                         Ptr<McpttCallMachineGrpBroadcastState> oldState,
                                         Ptr<McpttCallMachineGrpBroadcastState> newState)
{
    Ptr<McpttTimer> tfb1 = machine.GetTfb1();
    ...
    else if (oldState->GetInstanceStateId() == McpttCallMachineGrpBroadcastStateB4::GetStateId() &&
             newState->GetInstanceStateId() == McpttCallMachineGrpBroadcastStateB1::GetStateId())
    {
        NS_TEST_ASSERT_MSG_EQ(m_ueBB4ToB1,
                              false,
...
void
BroadcastCallScenario4::UeCTimerExpCb(const BroadcastTestCallMachine& machine,
                                      const McpttTimer& timer)
{
    Ptr<McpttTimer> tfb1 = machine.GetTfb1();
    Ptr<McpttTimer> tfb2 = machine.GetTfb2();
    ...
    if (timer.GetId() == machine.GetTfb1()->GetId())
    {
        ...
        NS_TEST_ASSERT_MSG_EQ(m_ueCRxGrpBroadcast,
                              true,
                              "UE C never received " << McpttCallMsgGrpBroadcast::GetTypeId()
                                                     << ".");
        NS_TEST_ASSERT_MSG_EQ(m_ueCB2ToB1,
                              true,
                              "UE C never made transition from "
...
BroadcastCallScenario4::UeCRxCb(const BroadcastTestCallMachine& machine, const McpttCallMsg& msg)
{
    ...
    if (msg.IsA(McpttCallMsgGrpBroadcast::GetTypeId()))
    {
        ...
        NS_TEST_ASSERT_MSG_EQ(m_ueCB2ToB1,
                              false,
                              "UE C already made transiton from "
                                  << McpttCallMachineGrpBroadcastStateB2::GetStateId() << " to "
                                  << McpttCallMachineGrpBroadcastStateB1::GetStateId() << ".");
        NS_TEST_ASSERT_MSG_EQ(state,
                              McpttCallMachineGrpBroadcastStateB2::GetInstance(),
                              "UE C is in " << state->GetInstanceStateId() << " not "
                                            << McpttCallMachineGrpBroadcastStateB2::GetStateId()
                                            << " state.");
        m_ueCRxGrpBroadcast = true;
    }
...
void
BroadcastCallScenario4::UeCStateChangeCb(const BroadcastTestCallMachine& machine,
                                         Ptr<McpttCallMachineGrpBroadcastState> oldState,
                                         Ptr<McpttCallMachineGrpBroadcastState> newState)
{
    Ptr<McpttTimer> tfb1 = machine.GetTfb1();
