...
class McpttHelper
{
  public:
     ...
     * applications.
     */
    virtual void AddPushersToOrchestrator(Ptr<McpttPusherOrchestratorInterface> orchestrator,
     ...
     * \param v7 the value of the attribute to set
     */
    virtual void SetPusherPttInterarrivalTimeVariable(
        std::string tid,
        std::string n0 = "",
        const AttributeValue& v0 = EmptyAttributeValue(),
        std::string n1 = "",
  ...
  private:
    ...
    bool m_releaseConfigured; //!< Indicates if the pusher's release variable was explicity
                              //!< configured.
