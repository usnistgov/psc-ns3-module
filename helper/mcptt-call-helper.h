...
class McpttCallHelper
{
  public:
     ...
     */
    uint16_t AddCall(ApplicationContainer clients,
                     Ptr<McpttServerApp> server,
                     uint32_t groupId,
     ...
     * \param stopTime stop time of the call
     */
    void AddCallOffNetwork(ApplicationContainer clients,
                           uint16_t callId,
                           Address peerAddress,
                           uint32_t groupId,
                           McpttCallMsgFieldCallType callType,
     ...
     */
    virtual void ConfigureOffNetworkBasicGrpCall(ApplicationContainer& apps,
                                                 Address peerAddress,
                                                 uint32_t usersPerGroup,
                                                 uint32_t baseGroupId = 1);
    /**
