...
uint16_t
McpttPttApp::GetCurrentMediaPortNumber()
{
    return s_mediaPortNumber;
}

uint16_t
McpttPttApp::AllocateNextMediaPortNumber()
{
    return s_mediaPortNumber++;
}

uint16_t
McpttPttApp::GetCurrentFloorPortNumber()
{
    return s_floorPortNumber;
}

uint16_t
McpttPttApp::AllocateNextFloorPortNumber()
{
    return s_floorPortNumber++;
}
