...
class McpttOnNetworkFloorTowardsParticipant : public Object, public McpttFloorMsgSink
{
  ...
  private:
    bool m_dualFloor; //!< The flag that indicates if the associated participant is listening to two
                      //!< sources.
    ...
    bool m_implicitRequest;           //!< The flag that indicates if SDP offer contains the
                                      //!< "mc_implicit_request" fmtp.
    ...
    bool m_originator; //!< Flag that indicates if the associated floor participant is the
                       //!< originator.
    bool m_overridden; //!< Flag that indicates if associated participant is overridden without
                       //!< revoke.
    bool m_overriding; //!< Flag that indicates if associated participant is overriding without
                       //!< revoke.
