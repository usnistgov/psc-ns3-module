...
class McpttOnNetworkFloorArbitrator : public Object
{
  public:
     ...
     */
    virtual void CallInitialized(Ptr<McpttOnNetworkFloorTowardsParticipant> participant,
     ...
     */
    virtual Ptr<McpttOnNetworkFloorTowardsParticipant> GetParticipantByUserId(
     ...
     */
    virtual Ptr<McpttOnNetworkFloorTowardsParticipant> GetParticipantBySsrc(
  ...
  private:
    ...
    bool m_queueingSupported; //!<< The flag that indicates if queueing of floor control requests is
                              //!< supported.
    std::vector<Ptr<McpttOnNetworkFloorTowardsParticipant>>
        m_participants;           //!< The associated floor participants.
  ...
  public:
    ...
    /**
     * Sets the reject cause to include in the revoke message when entering the 'G: pending Floor
     * Revoke' state. \param rejectCause The reject cause.
     */
