...
class McpttServerCall : public Object
{
  public:
     ...
     */
    virtual void ReceiveSipMessage(Ptr<Packet> pkt,
  ...
  private:
    ...
    bool m_ambientListening; //!< The flag that indicates if the call is configured for ambient
                             //!< listening.
    bool m_temporaryGroup;   //!< The flag that indicates if the call is configured for a temporary
                             //!< group.
