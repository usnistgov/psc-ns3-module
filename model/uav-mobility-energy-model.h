...
class UavMobilityEnergyModel : public DeviceEnergyModel
{
  ...
  private:
    ...
    double m_ascendEnergyConversionFactor;  //!< variable implementing AscendEnergyConversionFactor
                                            //!< attribute
    double m_descendEnergyConversionFactor; //!< variable implementing DescendEnergyConversionFactor
                                            //!< attribute
    double m_moveEnergyConversionFactor;    //!< variable implementing MoveEnergyConversionFactor
                                            //!< attribute
    double m_hoverEnergyCurrent;            //!< variable implementing HoverCurrent attribute

    TracedCallback<State, State, Vector>
        m_stateChangedTrace; //!< Variable storing state change callback
    TracedCallback<double, double, Vector>
        m_currentChangedTrace; //!< Variable storing current change callback
    TracedCallback<Ptr<const UavMobilityEnergyModel>>
        m_energyDepletionTrace; //!< variable storing energy depletion trace callback
    TracedCallback<Ptr<const UavMobilityEnergyModel>>
        m_energyRechargedTrace; //!< variable storing energy recharged trace callback
