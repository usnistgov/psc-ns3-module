...
{
    static TypeId tid =
        TypeId("ns3::psc::McpttPusherOrchestratorSpurtCdf")
      ...
      m_orchestrator(CreateObject<McpttPusherOrchestrator>())
{
    ...
    {
        pttDurationVariable->CDF(CDF_POINTS[i].first, CDF_POINTS[i].second);
    }
    ...
    m_orchestrator->TraceConnectWithoutContext(
        "PttDurationTrace",
        MakeCallback(&McpttPusherOrchestratorSpurtCdf::PttDurationTrace, this));
    m_orchestrator->TraceConnectWithoutContext(
        "PttInterarrivalTimeTrace",
        MakeCallback(&McpttPusherOrchestratorSpurtCdf::PttIatTrace, this));
}
...
void
McpttPusherOrchestratorSpurtCdf::ChangeCdf(Ptr<EmpiricalRandomVariable> pttDurationVariable,
                                           double avgPttDuration)
{
...
McpttPusherOrchestratorSpurtCdf::DoDispose()
{
    ...
    m_orchestrator->TraceDisconnectWithoutContext(
        "PttDurationTrace",
        MakeCallback(&McpttPusherOrchestratorSpurtCdf::PttDurationTrace, this));
    m_orchestrator->TraceDisconnectWithoutContext(
        "PttInterarrivalTimeTrace",
